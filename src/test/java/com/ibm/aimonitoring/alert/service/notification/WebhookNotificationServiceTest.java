...
class WebhookNotificationServiceTest {
    ...
    @BeforeEach
    void setUp() {
        service = new WebhookNotificationService(webClientBuilder, objectMapper);
    ...
    @Test
    void sendNotification_shouldThrowWhenNoWebhookUrl() {
        testChannel.setWebhookUrl(null);
    ...
    @Test
    void testConnection_shouldReturnFalseWhenNoUrl() {
        testChannel.setWebhookUrl(null);
